...
export default function Header({
	...
	return (
		<nav class="flex relative lg:h-[7rem] h-[4.125rem] bg-primary text-black w-full">
			...
			<ul class="left-4 top-1/2 absolute translate-y-[-50%] text-sm flex items-center gap-10 text-text hidden lg:flex font-semibold">
			...
			<div
				class={`left-1/2 top-1/2 absolute translate-[-50%] h-8 lg:h-[60px] ${tw(styles)}`}
				dangerouslySetInnerHTML={{ __html: logoSvg }}
			/>
			<ul class="right-4 top-1/2 absolute translate-y-[-50%] flex items-center gap-4">
