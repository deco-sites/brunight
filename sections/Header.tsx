...
export default function Header({
  ...
  return (
    <nav class="flex relative lg:h-[7rem] h-[4.125rem] bg-primary text-black w-full">
      <button
        type="button"
        class="left-4 top-1/2 absolute translate-y-[-50%] w-[1.8rem] h-5 lg:hidden"
      >
        <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31 21">
          <path
            d="M2 10.5h27.27M2 2h27.27M2 19h27.27"
            stroke="#000"
            stroke-width="2.5"
      ...
      <ul class="left-16 top-1/2 absolute translate-y-[-50%] text-sm flex items-center gap-10 text-text hidden lg:flex font-semibold">
      ...
      <div
        class={`left-1/2 top-1/2 absolute translate-[-50%] h-8 lg:h-[60px] ${
          tw(styles)
        }`}
        dangerouslySetInnerHTML={{ __html: logoSvg }}
      />
      <ul class="right-4 lg:right-16 top-1/2 absolute translate-y-[-50%] flex items-center gap-4">
        <li class="hidden sm:flex">
          <a href={`tel:${phone}`} class="text-sm text-center font-semibold">
            Sales: {phoneLabel}
          </a>
        </li>
        <li class="hidden lg:flex">
          <button href="/" class="flex justify-center text-text text-sm">
            <svg
              aria-hidden="true"
        ...
        <li class="hidden lg:flex">
          <button
            href="/"
            class="flex justify-center text-text text-sm w-5 h-5"
          >
            <svg
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            ...
            >
              ...
              >
                <path
                  d="M2.778 9.722a6.944 6.944 0 1113.889 0 6.944 6.944 0 01-13.89 0zM9.722 0C4.352 0 0 4.353 0 9.722c0 5.37 4.353 9.722 9.722 9.722a9.68 9.68 0 005.834-1.943c.039.051.082.1.129.148l6.944 6.944a1.389 1.389 0 101.964-1.964l-6.944-6.944a1.399 1.399 0 00-.148-.13 9.68 9.68 0 001.943-5.833C19.444 4.352 15.092 0 9.722 0z"
                  fill="#fff"
                />
              </mask>
              <g fill="currentColor" mask="url(#a)">
                <path d="M2.778 9.722a6.944 6.944 0 1113.889 0 6.944 6.944 0 01-13.89 0zM9.722 0C4.352 0 0 4.353 0 9.722c0 5.37 4.353 9.722 9.722 9.722a9.68 9.68 0 005.834-1.943c.039.051.082.1.129.148l6.944 6.944a1.389 1.389 0 101.964-1.964l-6.944-6.944a1.399 1.399 0 00-.148-.13 9.68 9.68 0 001.943-5.833C19.444 4.352 15.092 0 9.722 0z" />
        ...
        <li>
          <a
            href="/"
            class="flex justify-center rounded-[2rem] py-3 border-text border-1 text-sm min-w-[6rem] text-center"
          >
            Log In
          </a>
        </li>
